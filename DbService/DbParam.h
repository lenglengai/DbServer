...
namespace std {
	...
	{
	public:
		void setDbType(__i8 nDbType);
		__i8 getDbType() const;
		void setInt8(__i8 nValue);
		void setInt16(__i16 nValue);
		void setInt32(__i32 nValue);
		void setInt64(__i64 nValue);
		void setFloat(float nValue);
		void setDouble(double nValue);
		void setString(string& nValue);
		void * getDbValue();
	...
	typedef shared_ptr<DbParam> DbParamPtr;
